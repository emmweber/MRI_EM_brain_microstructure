function column_function_axon_diameter_dog_2024_mimic(idx_x,Delta,delta)
...
%load('/home/users/gchau/axon_code/dir_voung.mat','dir')
load('/home/gustavo/Gdrive/Stanford/Lab/ODF_prediction/sherlock_bash/dir_voung.mat','dir')
...
[protocol_init,protocolGEN, M] = protocol_design_2(param); % M is how many diffusion volumes you will obtain
